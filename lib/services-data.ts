...
export const HOTEL_PRICING: PricingPackage[] = [
  {
    ...
    isPopular: false,
    ctaText: "Get Started",
    ctaLink: "/contact?service=360&category=hotel&package=boutique",
  },
  {
    id: "hotel-medium",
    name: "Business Hotel",
    ...
    isPopular: false,
    ctaText: "Choose Package",
    ctaLink: "/contact?service=360&category=hotel&package=business",
  },
  {
    id: "hotel-premium",
    name: "Luxury Resort",
    description: "Complete solution for resorts",
    price: "₹45,999",
    priceNote: "+ GST",
    features: [
      "Up to 35 rooms/shots",
      "Premium Google integration",
      "Advanced interactive tour",
      "Lifetime support",
      "Website + mobile integration",
    ...
    isPopular: true,
    ctaText: "Get Premium Package",
    ctaLink: "/contact?service=360&category=hotel&package=luxury",
  },
  {
    id: "hotel-custom",
    name: "Hotel Chain",
    description: "Multi-property solutions",
    price: "Custom Pricing",
    priceNote: "",
    features: [
