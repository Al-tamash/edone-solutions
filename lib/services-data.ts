...
// Hospital-specific pricing packages
export const HOSPITAL_PRICING: PricingPackage[] = [
  {
    id: "hospital-small",
    name: "Small Clinic",
    description: "Perfect for clinics and small medical facilities",
    price: "₹12,891",
    priceNote: "+ GST",
    features: [
      "Up to 8 rooms/shots",
    ...
    isPopular: false,
    ctaText: "Get Started",
    ctaLink: "/contact?service=360&category=hospital&package=small-clinic",
  },
  {
    id: "hospital-medium",
    name: "Medium Facility",
    description: "Ideal for multi-specialty clinics",
    price: "₹21,971",
    priceNote: "+ GST",
    features: [
      "Up to 15 rooms/shots",
    ...
    ctaLink: "/contact?service=360&category=hospital&package=medium-facility",
  },
  {
    id: "hospital-premium",
    ...
    ctaLink: "/contact?service=360&category=hospital&package=hospital-premium",
  },
  {
    id: "hospital-custom",
    name: "Custom Healthcare",
    description: "Tailored solutions for large healthcare facilities",
    price: "Custom Pricing",
    priceNote: "",
    features: [
      "Tailored to your facility size",
      "Unlimited shots (as required)",
    ...
    isPopular: false,
    ctaText: "Contact Us",
    ctaLink: "/contact?service=360&category=hospital&package=custom",
  },
];

// Hotel-specific pricing packages
export const HOTEL_PRICING: PricingPackage[] = [
  {
    id: "hotel-basic",
    name: "Basic",
    description: "Up to 10 Areas",
    price: "₹15,620",
    priceNote: "+ GST",
    features: [
      "Up to 10 areas coverage",
      "Google Street View upload ✓",
      "Google Business Profile integration",
      "DSLR quality photos (5-10)",
      "Shareable link + QR code",
      "1 year support",
    ],
    isPopular: false,
    ctaText: "Get Started",
    ctaLink: "/contact?service=360&category=hotel&package=basic",
  },
  {
    id: "hotel-premium",
    name: "Premium",
    description: "Up to 20 Areas",
    price: "₹25,620",
    priceNote: "+ GST",
    features: [
      "Up to 20 areas coverage",
      "Google Street View upload ✓",
      "Google Business Profile integration",
      "Website embed code (1 year hosting)",
      "Interactive hotspots",
    ...
    isPopular: false,
    ctaText: "Choose Package",
    ctaLink: "/contact?service=360&category=hotel&package=premium",
  },
  {
    id: "hotel-platinum",
    name: "Platinum",
    description: "Up to 30 Areas",
    price: "₹34,620",
    priceNote: "+ GST",
    features: [
      "Up to 30 areas coverage",
      "Google Street View upload ✓",
      "Premium GBP optimization",
      "Website embed code (lifetime hosting)",
    ...
    isPopular: true,
    ctaText: "Get Premium Package",
    ctaLink: "/contact?service=360&category=hotel&package=platinum",
  },
  {
    id: "hotel-custom",
    name: "Custom",
    description: "Large / Multi-Campus Projects",
    price: "Quote Based",
    priceNote: "",
    features: [
      "Unlimited areas",
    ...
    isPopular: false,
    ctaText: "Contact Us",
    ctaLink: "/contact?service=360&category=hotel&package=custom",
  },
];

// Hotel Package Comparison Data
export const HOTEL_PACKAGE_COMPARISON = {
  title: "PACKAGE FEATURE COMPARISON",
  tiers: ["Basic", "Premium", "Platinum", "Custom"],
  features: [
    { name: "Google Street View Upload", basic: true, premium: true, platinum: true, custom: true },
    { name: "Google Business Profile Integration", basic: true, premium: true, platinum: true, custom: true },
    { name: "DSLR Quality Photos", basic: "5-10", premium: "10-15", platinum: "15-20", custom: "As Needed" },
    { name: "Shareable Link + QR Code", basic: true, premium: true, platinum: true, custom: true },
    { name: "Website Embed Code", basic: false, premium: "1 Year Hosting", platinum: "Lifetime Hosting", custom: "Custom" },
    { name: "Interactive Hotspots", basic: false, premium: true, platinum: true, custom: true },
    { name: "Full GBP Audit & Setup", basic: false, premium: true, platinum: true, custom: true },
    { name: "Floor Plan Integration", basic: false, premium: false, platinum: true, custom: "Custom" },
    { name: "Travel Included", basic: "no", premium: "no", platinum: true, custom: "Quote Based" },
    { name: "Support Duration", basic: "1 Year", premium: "3 Years", platinum: "Lifetime", custom: "Priority" },
  ],
};

// Jewellery-specific pricing packages
export const JEWELLERY_PRICING: PricingPackage[] = [
  {
    id: "jewellery-small",
    name: "Boutique Store",
    description: "Perfect for small jewellery shops",
    price: "₹18,500",
    priceNote: "+ GST",
    features: [
      "Up to 8 display cases",
      "Google Business integration",
      "High-detail product shots",
      "1 year support",
    ],
    isPopular: false,
    ctaText: "Get Started",
    ctaLink: "/contact?service=360&category=jewellery&package=boutique",
  },
  {
    id: "jewellery-medium",
    name: "Showroom",
    description: "Ideal for established showrooms",
    price: "₹32,500",
    priceNote: "+ GST",
    features: [
      "Up to 15 display sections",
      "Enhanced Google integration",
      "Collection navigation",
      "3 years support",
      "Website integration",
      "Bridal section highlight",
    ],
    isPopular: false,
    ctaText: "Choose Package",
    ctaLink: "/contact?service=360&category=jewellery&package=showroom",
  },
  {
    ...
    priceNote: "+ GST",
    features: [
      "Full showroom coverage",
      "Premium Google integration",
      "Virtual appointment booking",
      "Lifetime support",
      "Collection hotspot links",
      "Artisan workshop tours",
      "Festival collection updates",
    ],
    isPopular: true,
    ctaText: "Get Premium Package",
    ctaLink: "/contact?service=360&category=jewellery&package=heritage",
  },
  {
    id: "jewellery-custom",
    name: "Multi-Store Chain",
    description: "For jewellery retail chains",
    price: "Custom Pricing",
    priceNote: "",
    features: [
      ...
      "NRI customer features",
      "Dedicated support",
    ],
    isPopular: false,
    ctaText: "Contact Us",
    ctaLink: "/contact?service=360&category=jewellery&package=custom",
  },
];

// School-specific pricing packages
export const SCHOOL_PRICING: PricingPackage[] = [
  {
    id: "school-small",
    name: "Primary School",
    ...
    isPopular: false,
    ctaText: "Get Started",
    ctaLink: "/contact?service=360&category=school&package=primary",
  },
  {
    id: "school-medium",
    name: "High School",
    description: "Ideal for K-12 institutions",
    price: "₹26,500",
    priceNote: "+ GST",
    features: [
      "Up to 20 locations",
    ...
    isPopular: false,
    ctaText: "Choose Package",
    ctaLink: "/contact?service=360&category=school&package=highschool",
  },
  {
    id: "school-premium",
    name: "University Campus",
    description: "Complete institution coverage",
    price: "₹48,000",
    priceNote: "+ GST",
    features: [
      ...
      "Lifetime support",
      "Hostel & cafeteria tours",
      "Faculty introductions",
      "Event space tours",
    ],
    isPopular: true,
    ctaText: "Get Premium Package",
    ctaLink: "/contact?service=360&category=school&package=university",
  },
  {
    id: "school-custom",
    name: "Education Group",
    description: "For educational chains",
    price: "Custom Pricing",
    priceNote: "",
    features: [
      "Multiple campuses",
    ...
    isPopular: false,
    ctaText: "Contact Us",
    ctaLink: "/contact?service=360&category=school&package=custom",
  },
];

// Hardware-specific pricing packages
export const HARDWARE_PRICING: PricingPackage[] = [
  {
    id: "hardware-small",
    name: "Retail Store",
    description: "Perfect for hardware retail shops",
    price: "₹12,000",
    priceNote: "+ GST",
    features: [
      "Up to 8 sections",
    ...
    isPopular: false,
    ctaText: "Get Started",
    ctaLink: "/contact?service=360&category=hardware&package=retail",
  },
  {
    id: "hardware-medium",
    name: "Showroom",
    description: "Ideal for large showrooms",
    price: "₹22,000",
    priceNote: "+ GST",
    features: [
      "Up to 15 sections",
    ...
    isPopular: false,
    ctaText: "Choose Package",
    ctaLink: "/contact?service=360&category=hardware&package=showroom",
  },
  {
    id: "hardware-premium",
    name: "Warehouse",
    description: "Complete B2B solution",
    price: "₹38,000",
    priceNote: "+ GST",
    features: [
    ...
    isPopular: true,
    ctaText: "Get Premium Package",
    ctaLink: "/contact?service=360&category=hardware&package=warehouse",
  },
  {
    id: "hardware-custom",
    name: "Distribution Network",
    description: "For wholesale chains",
    price: "Custom Pricing",
    priceNote: "",
    features: [
      "Multiple locations",
      "Dealer network tours",
      "Inventory integration",
      "B2B features",
      "Dedicated support",
    ],
    isPopular: false,
    ctaText: "Contact Us",
    ctaLink: "/contact?service=360&category=hardware&package=custom",
  },
];
...
export const VIRTUAL_TOUR_CATEGORIES: VirtualTour360Category[] = [
  {
    ...
    testimonials: [
      ...
      {
        id: "hotel-test-3",
        quote: "Direct bookings increased by 35% within the first month of launching our virtual tour. Best investment we made!",
        authorName: "Vikram Singh",
        authorTitle: "Revenue Manager",
        company: "City Comfort Suites",
        rating: 5,
      },
    ],
    clients: [
  ...
  },
  {
    ...
    testimonials: [
      ...
      {
        id: "hospital-test-2",
        quote: "International patients now choose us after exploring our facilities virtually. It has boosted medical tourism.",
        authorName: "Dr. Sanjay Gupta",
        authorTitle: "Hospital Director",
        company: "Wellness Multi-Specialty",
        rating: 5,
      },
      {
        id: "hospital-test-3",
        quote: "The virtual tour reduced patient anxiety significantly. They arrive calm knowing what to expect.",
        authorName: "Nurse Sunita Devi",
        authorTitle: "Head Nurse",
  ...
  },
  {
    ...
    testimonials: [
      ...
      {
        id: "jewellery-test-2",
        quote: "Our virtual tour has become our best sales tool. Customers spend more time exploring collections before visiting.",
        authorName: "Priya Mehta",
        authorTitle: "Store Manager",
        company: "Diamond House",
        rating: 5,
      },
      {
        id: "jewellery-test-3",
        quote: "Wedding families from other cities now book appointments after touring our bridal collection virtually.",
        authorName: "Ramesh Jain",
        authorTitle: "Director",
        company: "Heritage Gold Palace",
        rating: 5,
      },
    ],
    clients: [
  ...
  },
  {
    ...
    testimonials: [
      ...
      {
        id: "school-test-2",
        quote: "Admission inquiries doubled after we launched the virtual tour. Parents love exploring our labs virtually.",
        authorName: "Mr. Rajendra Singh",
        authorTitle: "Admission Director",
        company: "City Public School",
        rating: 5,
      },
      {
        id: "school-test-3",
        quote: "Our hostel tour gives NRI parents peace of mind. They can see exactly where their children will stay.",
        authorName: "Mrs. Sudha Krishnan",
  ...
  },
  {
    ...
    testimonials: [
      ...
      {
        id: "hardware-test-2",
        quote: "B2B clients save travel time by inspecting our plywood stock online. Orders have increased 40%.",
        authorName: "Krishna Murthy",
        authorTitle: "Owner",
        company: "City Plywood Center",
        rating: 5,
      },
      {
        id: "hardware-test-3",
        quote: "Bulk buyers now finalize orders faster after virtual warehouse tours. No more surprise visits!",
        authorName: "Amit Sharma",
        authorTitle: "Sales Manager",
